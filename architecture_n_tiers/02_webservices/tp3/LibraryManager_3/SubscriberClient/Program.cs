...
namespace LibrarianClient
{
    ...
    class Program
    {
        ...
        private const string SUBSCRIBERS_CONTROLLER = "http://localhost31101/api/subscribers/";
        private const string COMMENTS_CONTROLLER = "http://localhost31101/api/comments/";
