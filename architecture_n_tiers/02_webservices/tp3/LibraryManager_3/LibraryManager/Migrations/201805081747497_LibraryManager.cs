namespace LibraryManager.Database
{
    ...
    public partial class LibraryManager : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.BookID, t.SubscriberID })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "SubscriberID", "dbo.Subscribers");
            ...
            DropIndex("dbo.Comments", new[] { "SubscriberID" });
