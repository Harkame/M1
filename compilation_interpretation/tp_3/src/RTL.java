...
/*
 * We deal only with global variables. Local variables are pseudo-registers.
 */
...
/*
 * Used for the "not" operation not(e) = xori %1, %0, 1
 */
...
class RTLAdd extends RTLBinOp
{
	...
	RTLAdd(PRegister regIn1, PRegister regIn2, PRegister regOut, RTLInst succ)
	{
		this.regIn1 = regIn1;
		this.regIn2 = regIn2;
		this.regOut = regOut;
...
class RTLSub extends RTLBinOp
{
	...
	RTLSub(PRegister regIn1, PRegister regIn2, PRegister regOut, RTLInst succ)
	{
		this.regIn1 = regIn1;
		this.regIn2 = regIn2;
		this.regOut = regOut;
...
class RTLMul extends RTLBinOp
{
	...
	RTLMul(PRegister regIn1, PRegister regIn2, PRegister regOut, RTLInst succ)
	{
		this.regIn1 = regIn1;
		this.regIn2 = regIn2;
		this.regOut = regOut;
...
class RTLDiv extends RTLBinOp
{
	...
	RTLDiv(PRegister regIn1, PRegister regIn2, PRegister regOut, RTLInst succ)
	{
		this.regIn1 = regIn1;
		this.regIn2 = regIn2;
		this.regOut = regOut;
...
class RTLAnd extends RTLBinOp
{
	...
	RTLAnd(PRegister regIn1, PRegister regIn2, PRegister regOut, RTLInst succ)
	{
		this.regIn1 = regIn1;
		this.regIn2 = regIn2;
		this.regOut = regOut;
...
class RTLOr extends RTLBinOp
{
	...
	RTLOr(PRegister regIn1, PRegister regIn2, PRegister regOut, RTLInst succ)
	{
		this.regIn1 = regIn1;
		this.regIn2 = regIn2;
		this.regOut = regOut;
...
class RTLFunCall extends RTLCall
{
	...
	RTLFunCall(Callee callee, ArrayList<PRegister> args, PRegister reg, RTLInst succ)
	{
		this.callee = callee;
		this.args = args;
		this.reg = reg;
...
/*
 * For arrays, the address is computed with the offset. Therefore, there is no
 * offset variable.
 */
...
class RTLFun extends RTLDef
{
	...
	RTLFun(String name, ArrayList<PRegister> args, ArrayList<PRegister> locals, PRegister regRet, RTLInst body)
	{
		this.name = name;
		this.args = args;
		this.locals = locals;
...
class RTLProc extends RTLDef
{
	...
	RTLProc(String name, ArrayList<PRegister> args, ArrayList<PRegister> locals, RTLInst body)
	{
		this.name = name;
		this.args = args;
		this.locals = locals;
