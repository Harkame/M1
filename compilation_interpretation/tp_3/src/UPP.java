...
abstract class UPPExpr
{
	...
	abstract RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals, ArrayList<String> globals, PRegister reg,
			RTLInst succ);
...
class UPPAnd extends UPPBinOp
{
	...
	RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ)
	{
		return new RTLAnd(e1.getPRegister(locals), e2.getPRegister(locals), reg, succ);
	}// toRTL
...
class UPPOr extends UPPBinOp
{
	...
	RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals, ArrayList<String> globals, PRegister reg, RTLInst succ)
	{
		return new RTLOr(e1.getPRegister(locals), e2.getPRegister(locals), reg, succ);
	}// toRTL
...
abstract class UPPInst
{
	...
	abstract RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals, ArrayList<String> globals, RTLInst succ);
...
class UPPCond extends UPPInst
{
	...
	RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals, ArrayList<String> globals, RTLInst succ)
	{
		return cond.toRTL(locals, globals, cond.getPRegister(locals), new RTLGtz(cond.getPRegister(locals),
				i1.toRTL(locals, globals, succ), i2.toRTL(locals, globals, succ)));
	}// toRTL
...
class UPPProcCall extends UPPInst
{
	...
	RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals, ArrayList<String> globals, RTLInst succ)
	{
		ArrayList<PRegister> t_locals = new ArrayList<PRegister>();
		for (Pair<String, PRegister> t_pair : locals)
			t_locals.add(t_pair.right);

		return new RTLProcCall(callee, t_locals, succ);
	}// toRTL
...
class UPPSeq extends UPPInst
{
	...
	RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals, ArrayList<String> globals, RTLInst succ)
	{
		return i1.toRTL(locals, globals, i2.toRTL(locals, globals, succ));
	}// toRTL
...
class UPPFun extends UPPDef
{
	...
	UPPFun(String name, ArrayList<String> args, ArrayList<String> locals, UPPInst code)
	{
		this.name = name;
		this.args = args;
		this.locals = locals;
...
class UPPProc extends UPPDef
{
	...
	UPPProc(String name, ArrayList<String> args, ArrayList<String> locals, UPPInst code)
	{
		this.name = name;
		this.args = args;
		this.locals = locals;
	...
	RTLDef toRTL(ArrayList<String> globals)
	{
		ArrayList<PRegister> t_args = new ArrayList<PRegister>();
		ArrayList<PRegister> t_locals = new ArrayList<PRegister>();

		ArrayList<Pair<String, PRegister>> reg_args = new ArrayList<Pair<String, PRegister>>();
		...
		return new RTLProc(name, t_args, t_locals, code.toRTL(reg_args, locals, null));
	}// toRTL
